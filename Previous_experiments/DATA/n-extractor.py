...
def check_for_undeclinables(lexeme, analysis, language):
    ...
    # if all lexemes are the same in analyses, and they are included for all cases, put word in undeclinable readings #
    ...
    for filean in os.listdir(path="./files/"):
        if filean.endswith(".txt"):
            ...
            with open("./files/cleaned/" + "indeclensible" + filean, "w+", encoding="utf-8") as w:
                w.write("".join(undeclinable_readings))
